...
class DATA():
    ...
    def __init__(self):
        self.dir_path = os.path.join("../trained/val_data", "")
        self.test_data_path = os.path.join("../trained/test_data", "")
    ...
    def generate_result(self):
        self.generator = tf.keras.models.load_model('../trained/my_model_colorizationEpoch4.h5')
